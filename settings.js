...
(function () {
  ...
  // ---- Load About section: version + last 10 commits from local commit-log.json ----
  function loadAboutSection() {
    ...
    // Commit history table — reads from local commit-log.json (generated by GitHub Action on each push)
        ...
        const rows = commits.map(c => {
          ...
          return `<tr>
            <td style="font-family:monospace;font-size:var(--text-xs);white-space:nowrap;padding:var(--space-2) var(--space-3);vertical-align:top;border-bottom:1px solid var(--color-divider);">
              <a href="${c.url}" target="_blank" rel="noopener noreferrer" style="color:var(--color-primary);text-decoration:none;">${c.sha}</a>
            </td>
